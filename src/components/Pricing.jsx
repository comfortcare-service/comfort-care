    ...
    <section className="py-20 bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="inline-flex items-center bg-green-100 text-green-800 px-4 py-2 rounded-full text-sm font-semibold mt-4">
        ...
        {/* Visit charge banner */}
        <div className="bg-white rounded-3xl shadow-xl p-8 mb-12 border border-blue-200">
          <div className="text-center">
            <div className="w-16 h-16 bg-gradient-to-r from-primary-500 to-primary-600 rounded-full flex items-center justify-center mx-auto mb-4">
              <FontAwesomeIcon icon={faHome} className="text-2xl text-white" />
            </div>
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Service Visit Charge</h3>
            <div className="text-4xl font-bold text-primary-600 mb-2">₹150</div>
            <p className="text-gray-600 mb-4">For diagnosis and minor repairs within 30 minutes</p>
            <div className="inline-flex items-center bg-accent-100 text-accent-800 px-3 py-1 rounded-full text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {PRICING_CARDS.map((card) => (
            <div
              key={card.title}
              className={`bg-white rounded-3xl shadow-lg hover-float p-8 border ${card.border}`}
            >
              <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 border border-orange-100">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-6">Microwave Services</h3>
          ...
          {/* Emergency */}
          <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-3xl shadow-lg p-8 border-2 border-red-200">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-6">Emergency &amp; Extra</h3>
            <div className="space-y-3">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6 mt-12">
          <div className="flex items-start">
            <div className="w-8 h-8 bg-amber-100 rounded-full flex items-center justify-center mr-4 mt-1 shrink-0">
              ...
              <ul className="space-y-2 text-sm text-amber-800">
                {NOTES.map((note) => (
                  <li key={note} className="flex items-start">
                    <FontAwesomeIcon
                      icon={faCheck}
                      className="text-amber-600 mr-2 mt-0.5 text-xs shrink-0"
                    />
                    {note}
                  </li>
                ))}
